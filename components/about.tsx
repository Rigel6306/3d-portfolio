...
const About = () => {
    ...
    return (
        ...
        <section id='about' className="p-4 sm:p-6 md:p-8 mt-20 sm:mt-40 overflow-x-hidden flex flex-col items-center "  >
            ...
            ">
                {/* Grid item 1 */}
                <div className="flex flex-col justify-end items-start row-span-1 md:row-span-2 col-span-1 md:col-span-3 h-60 md:h-full relative overflow-hidden hover:-translate-y-1 duration-200 grid-default-color ">
